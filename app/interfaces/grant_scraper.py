...
class HttpClientInterface(ABC):
    ...
    @abstractmethod
    def get(self, url: str, headers: Optional[Dict[str, str]] = None, timeout: int = 30) -> 'HttpResponse':
        """
    ...
    @abstractmethod
    def post(self, url: str, data: Optional[Dict[str, Any]] = None, headers: Optional[Dict[str, str]] = None, timeout: int = 30) -> 'HttpResponse':
        """
