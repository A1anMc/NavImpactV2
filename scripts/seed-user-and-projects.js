...
async function seedUserAndProjects() {
  console.log('🌱 Starting user and project seeding...');
  ...
  try {
    ...
    const authToken = await loginUser(userData);
...
// Run the seeding
seedUserAndProjects().catch(console.error); 