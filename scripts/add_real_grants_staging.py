#!/usr/bin/env python3
"""
Add Real Grant Data to Staging Database
This script adds realistic grant data to the NavImpact staging database.
"""
...
# Staging API URL
API_BASE = "https://navimpact-api-staging.onrender.com/api/v1"

def add_real_grants():
    """Add realistic grant data to the staging database."""
    
    print("🎯 ADDING REAL GRANT DATA TO STAGING")
    print("=====================================")
    print("")
    
    # Real grant data for NavImpact staging
    real_grants = [
        {
    ...
    print(f"📊 Adding {len(real_grants)} real grants to staging database...")
    print("")
    ...
    if success_count > 0:
        print("🎉 Real grant data has been added to staging!")
        print("🌐 Test the staging frontend: https://navimpact-web-staging.onrender.com/grants/")
        print("")
        print("You should now see real grant data instead of fallback data.")
    else:
        print("❌ No grants were added. Check the staging API connection and try again.")
