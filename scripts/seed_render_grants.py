#!/usr/bin/env python3
"""
Script to seed Render database with additional grants
"""
...
def check_api_health():
    ...
    try:
        response = requests.get(f"{RENDER_API_URL}/api/v1/health/", timeout=10)
...
def main():
    print("🚀 Seeding Render Database with Additional Grants")
    print("=" * 50)
