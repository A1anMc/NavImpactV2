  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-sge': 'linear-gradient(135deg, #181818 0%, #425627 50%, #885C24 100%)',
        'gradient-sge-subtle': 'linear-gradient(135deg, rgba(24, 24, 24, 0.05) 0%, rgba(66, 86, 39, 0.05) 50%, rgba(136, 92, 36, 0.05) 100%)',
      },
    },
  },
  plugins: [],
