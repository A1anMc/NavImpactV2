...
export default function ProjectsPage() {
  ...
  const mockProjects: Project[] = [
    {
      ...
      description: 'Empowering elderly community members with essential digital skills',
      status: 'active',
    ...
    },
    {
      ...
      description: 'Creating sustainable green spaces in urban communities',
      status: 'active',
      outcome_text: '3 new community gardens established, serving 500+ residents',
    ...
    },
    {
      ...
      description: 'Providing job readiness training for disadvantaged youth',
      status: 'completed',
      outcome_text: '15% increase in employment rate for program participants',
    ...
    {
      id: 4,
      name: 'Renewable Energy Community Project',
      description: 'Installing solar panels in community buildings',
      status: 'planning',
      outcome_text: 'Planned 40% reduction in community carbon footprint',
  ...
  const displaySummary = mockPortfolioSummary;
