...
class TestRefactoredServices:
    ...
    def test_grant_service_get_accessible_grant_success(
        self, mock_db, mock_notification_service, sample_grant, sample_user
    ):
    ...
    def test_grant_service_get_accessible_grant_not_found(
        self, mock_db, mock_notification_service, sample_user
    ):
    ...
    def test_grant_service_get_accessible_grant_inactive(
        self, mock_db, mock_notification_service, sample_user
    ):
    ...
    def test_grant_service_find_matching_grants(
        self, mock_db, mock_notification_service, sample_user
    ):
    ...
    def test_grant_service_get_grant_recommendations(
        self, mock_db, mock_notification_service, sample_user
    ):
    ...
    def test_grant_service_calculate_match_score(
        self, mock_db, mock_notification_service, sample_user
    ):
        ...
        assert (
            perfect_score > 0.6
        )  # Should have high score (adjusted for realistic expectations)
    ...
    def test_grant_service_get_match_reasons(
        self, mock_db, mock_notification_service, sample_user
    ):
