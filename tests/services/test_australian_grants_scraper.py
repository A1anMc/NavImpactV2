...
class TestAustralianGrantsScraper:
    ...
    @pytest.mark.asyncio
    @patch(
        "app.services.scrapers.australian_grants_scraper.AustralianGrantsScraper._make_request"
    )
    async def test_parse_screen_australia(
        self, mock_make_request, scraper, sample_html
    ):
    ...
    async def test_parse_creative_australia(
        self, mock_make_request, scraper, sample_creative_australia_html
    ):
    ...
    @patch("asyncio.sleep")
    async def test_scrape_integration(
        self, mock_sleep, mock_make_request, scraper, sample_html
    ):
